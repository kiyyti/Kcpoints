        ...
        <div class="box profile-box">
            <div class="profile-header">
                <div class="profile-details">
                    <img src="../public/picture/krupom.jpg" alt="User Avatar" class="profileuser">
                    <div class="profile-info">
                        <h2 class="username">นายกิตติ เจียมอนุกูลกิจ</h2>
                        <p id="point">Points: <span id="point">180</span></p>
                    </div>
                </div>
                <!-- ปุ่มแก้ไขโปรไฟล์ -->
                <button class="edit-profile-btn">แก้ไขโปรไฟล์</button>
            </div>
        </div>
            ...
            <div class="left-column">
                ...
                <div class="box stats-box">
                    ...
                    <ul>
                        ...
                        <li id="total-points">กิจกรรมที่เข้าร่วม: <span id="total-points">6</span></li>
                        <li id="badges-count">คะแนนคงเหลือ: <span id="badges-count">180</span></li>
                    </ul>
                </div>
